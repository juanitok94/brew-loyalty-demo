...
export const metadata = {
  title: "Terms & Conditions — Loyalty Card",
};
...
export default function TermsPage() {
  return (
    <main className="min-h-screen px-6 py-10 max-w-2xl mx-auto">
      ...
      <p className="text-lg font-semibold text-[#8B1E1E] mb-6">Loyalty Card</p>
      ...
      >
        ...
        <p><span className="font-semibold">Program:</span> Loyalty Card, powered by Brew Loyalty</p>
        <p><span className="font-semibold">Venue:</span> Your Coffee Shop, North Carolina</p>
      </div>
      ...
      <div className="space-y-8" style={{ color: "var(--foreground)" }}>
        ...
        <section>
          ...
          <p className="mb-3">When you sign up for the Loyalty Card, we collect:</p>
          ...
          <p>
            ...
            your loyalty account. This is how we distinguish your card from other customers —
            no account login or app download required.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-1 mb-3 pl-1">
            <li>Create and track your loyalty stamp card</li>
            <li>Identify your account when you visit the shop</li>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                <tr className="border-t" style={{ borderColor: "var(--stamp-empty)" }}>
                  <td className="px-4 py-3 font-medium">Coffee shop staff</td>
        ...
        <section>
          ...
          >
            ...
            <p><span className="font-semibold">Subject:</span> Delete My Loyalty Card Account</p>
          </div>
        ...
        <section>
          ...
          <p>
            This loyalty program is intended for customers 13 years of age and older. We do not
        ...
        >
          This loyalty card is operated by Peachy Kean DevOps LLC on behalf of participating
          coffee shops. Buy 9 coffee/tea drinks, get the 10th free. One stamp per drink.
        </p>
      </div>
    </main>
  );
